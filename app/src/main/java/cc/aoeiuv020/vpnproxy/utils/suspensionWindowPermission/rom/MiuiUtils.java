 ...
 */
package cc.aoeiuv020.vpnproxy.utils.suspensionWindowPermission.rom;
...
import static cc.aoeiuv020.vpnproxy.utils.ConstantUtils.SUSPENSION_WINDOW_PERMISSION_CALLBACK;
...
//        intent.setData(uri);
        ...
        if (isIntentAvailable(intent, context)) {
            context.startActivityForResult(intent, SUSPENSION_WINDOW_PERMISSION_CALLBACK);
        } else {
