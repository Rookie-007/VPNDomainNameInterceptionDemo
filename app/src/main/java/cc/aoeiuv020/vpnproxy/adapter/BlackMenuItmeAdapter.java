...
public class BlackMenuItmeAdapter extends SwipeMenuAdapter {
    List<BlacklistOfWebsitesBean> menuList;
    private Activity activity;
    private LinearLayout llNotData;

    public BlackMenuItmeAdapter(Activity activity, List<BlacklistOfWebsitesBean> relativePhoneBeanList, LinearLayout llNotData) {
                ...
                if (Utils.isFastClick()) {
                    ...
                    CustomDialog.getInstance().addRelativePhoneDialog(activity, new IDialogCallBack() {
                        ...
                        public void determine(AlertDialog dialog, String websiteUrl) {
                            dialog.dismiss();
                            //插入黑名单数据
                            BlacklistOfWebsitesCtrls.insterBlacklistOfWebsitesBean(oldWebsiteUrl,websiteUrl);
                            //刷新数据
                            notifycation();
                        }
                    ...
                    },1,activity.getResources().getString(R.string.blacklist_of_websites),oldWebsiteUrl,"");
                }
            }
        });
    }
    ...
    public void notifycation(){
        List<BlacklistOfWebsitesBean> list = BlacklistOfWebsitesCtrls.getAllBlacklistOfWebsitesBean();
