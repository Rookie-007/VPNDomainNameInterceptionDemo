...
public class KeywordMenuItmeAdapter extends SwipeMenuAdapter {
    List<KeywordAddressWebsitesBean> menuList;
    private Activity activity;
    private LinearLayout llNotData;

    public KeywordMenuItmeAdapter(Activity activity, List<KeywordAddressWebsitesBean> relativePhoneBeanList, LinearLayout llNotData) {
                ...
                if (Utils.isFastClick()) {
                    ...
                    CustomDialog.getInstance().addRelativePhoneDialog(activity, new IDialogCallBack() {
                        ...
                        public void determine(AlertDialog dialog, String websiteUrl) {
                            dialog.dismiss();
                            //插入黑名单数据
                            KeywordAddressWebsitesCtrls.insterBlacklistOfWebsitesBean(oldWebsiteUrl,websiteUrl);
                            //刷新数据
                            notifycation();
                        }
                    ...
                    },1,activity.getResources().getString(R.string.keyword_filtering),oldWebsiteUrl,"");
                }
            }
        });
    }
    ...
    public void notifycation(){
        List<KeywordAddressWebsitesBean> list = KeywordAddressWebsitesCtrls.getAllBlacklistOfWebsitesBean();
